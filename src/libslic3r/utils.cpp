...
{
    // OpenSSL disabled in this build - MD5 calculation not available
    BOOST_LOG_TRIVIAL(warning) << "MD5 calculation requested but OpenSSL is not available in this build";
    md5_out = "00000000000000000000000000000000";  // Return placeholder MD5
    return false;

    // Original OpenSSL implementation disabled:
